  ...
  return (
    <div className={`${theme ? "bg-[#172437]": "bg-white"} rounded flex justify-between p-5 shadow-sm shadow-[#7367F0]`}>
      ...
      <div className="flex gap-4 items-center">
        ...
        />
        {
          theme ? <MdOutlineDarkMode className="cursor-pointer" onClick={() => setTheme(!theme)} size={24} /> : <MdOutlineLightMode className="cursor-pointer" onClick={() => setTheme(!theme)} size={24} /> 
        }
